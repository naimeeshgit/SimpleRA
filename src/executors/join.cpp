...
void executeJOIN()
{
    ...
    firstTable->join(secondTable, parsedQuery.joinFirstColumnName, parsedQuery.joinSecondColumnName, parsedQuery.joinBinaryOperator, parsedQuery.joinResultRelationName);
    return;
}